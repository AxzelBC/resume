...
\section{Experiencia}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Implementación de metodologías ágiles como SCRUM, configuración de Azure Devops y gestión de la nube (Azure).}
    \resumeItem{Creación de funciones sin servidor.}
  \resumeItemListEnd
